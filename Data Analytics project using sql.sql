--Q1: Who is the senior most employee based on the jobe title?
query:
...
--the most money. Write a query that returns one city that highest sum of invoice total. Return both the city
name & sum of all inovice totals
query:
...
--Write a query that returns the person whos has spent the most money
query:
...
--Q6: write query to return email, fist_name, last_name & Genre of all Rock Music listeners. Rturn your list
